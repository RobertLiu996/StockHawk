...
public class StockTaskService extends GcmTaskService{
  ...
  @IntDef({STATUS_OK, STATUS_ERROR_JSON,STATUS_SERVER_ERROR,
          STATUS_SERVER_DOWN, STATUS_UNKNOWN })
  ...
  static public void setStockStatus(Context context, @StockStatuses int status) {
